-- Sample Data for YWMDSBS School Management System (No Users Table Version)
-- This script creates realistic test data without requiring a users table
-- Assumes teachers and students tables have user_id as foreign key
...
-- 2. Insert Teachers (with user_id references)
...
-- 3. Insert Students (with user_id references)
...
-- Note: This version assumes you have authentication handled elsewhere
-- The user_id fields reference the IDs that should exist in your auth system
-- You may need to create corresponding auth records or adjust the user_id values
